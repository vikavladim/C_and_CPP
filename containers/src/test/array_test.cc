...
class ArrayTest : public ::testing::Test {
 protected:
  ...
  vv::array<double, 6> arr = {1, 2, 3, 4};
  std::array<std::string, 6> std_arr2 = {"232", "232", "232", "232"};
  vv::array<std::string, 6> arr2 = {"232", "232", "232", "232"};
  const std::array<double, 6> std_const_arr = {1, 2, 3, 4};
  const vv::array<double, 6> const_arr = {1, 2, 3, 4};
  std::array<const std::vector<int>, 2> std_arr_const_vec = {
      {{1, 2, 3}, {1, 2, 3}}};
  vv::array<const std::vector<int>, 2> arr_const_vec = {{{1, 2, 3}, {1, 2, 3}}};
  std::array<int, 10> std_base_constructor = std::array<int, 10>();
  vv::array<int, 10> base_constructor = vv::array<int, 10>();
  vv::array<int, 0> zero_arr = vv::array<int, 0>();
...
TEST_F(ArrayTest, modifiers) {
  ...
  vv::array<double, 6> arr_analog = {4, 3, 2, 1};
  arr_analog.swap(arr);
  ...
  vv::array<std::string, 6> arr2_analog = {"new", "new", "new", "new"};
