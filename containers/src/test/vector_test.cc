...
class VectorTest : public ::testing::Test {
 protected:
  ...
  template <typename T>
  static void check_with_std(const vv::vector<T>& vec,
...
TEST_F(VectorTest, ElementAccess) {
  vv::vector<testClass> vec = {{"12", "12"}, {"22", "234"}, {"ddd", "aaa"}};
  ...
  const vv::vector<testClass> const_vec = {
...
TEST_F(VectorTest, InsertMany) {
  vv::vector<testClass> test_vector = {{"1", "2"}};
